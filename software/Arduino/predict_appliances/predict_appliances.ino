...
#define PDM_SOUND_GAIN     50   // sound gain of PDM mic
...
const String words[NUMBER_OF_LABELS] = {"microwave_opening", "microwave_closing", "fridge_closing", "blender"};  // words for each label
