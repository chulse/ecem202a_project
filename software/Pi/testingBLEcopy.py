...
EVENTS = {  "Blender":{"threshold" : 5,"type":event_type.continuous},
            ...
            "Hair Dryer":{"threshold" : 5,"type":event_type.continuous},
            "Water Kettle":{"threshold" : 5,"type":event_type.continuous},
...
def notification_handler(sender, data):
    ...
    print("{0}: {1} {2}".format(sender, event_number, EVENT_INDEX[event_number]))
